...
str = {'time','vel','amplitude gauss','sigma','lattice density','bg density','MT tip','shift gauss','sigma gauss','tau','sum square error', 'Ase1 in Gauss', 'Ase1 in extension', 'amplitude + lattice density', 'Ase1 passed', 'Ase1 passed/distance'};
