...
str = {'time','vel','amplitude gauss','sigma','lattice density','bg density','MT tip','shift gauss','sigma gauss','tau','sum square error', 'Ase1 in Gauss', 'Ase1 in extension', 'amplitude + lattice density', 'Ase1 passed'};
unit = {'s','nm/s','1','nm','1','1','nm','nm','nm','nm','1sq', '1', '1', '1', '1'};
tooltipstr=sprintf(['Set the X variable.']); %lPlot_XVar and lPlot_YVar are set in DF.updateOptions()
...
VarOptions = {'No reference','Previous data point','Shifted to previous','Median', 'Track velocity','Start','End'};                         
