...
str = {'time','distance','vel','amplitude gauss','sigma','lattice density','bg density','MT tip','shift gauss','sigma gauss','tau','sum square error', 'Ase1 in Gauss', 'Ase1 under Gauss'};
unit = {'s','nm','nm/s','1','nm','1','1','nm','nm','nm','nm','1sq', '1', '1'};
tooltipstr=sprintf(['Set the X variable.']); %lPlot_XVar and lPlot_YVar are set in DF.updateOptions()
...
hDFGui.lPlot_ZVardim = uicontrol('Parent',hDFGui.pOptions,'Units','normalized','Callback',@DF.updateOptions,'String',dimstr,...
...
VarOptions = {'No reference','Previous data point','empty','Median', 'Track velocity','Start','End'};                         
